import{d as C,r as c,b,w as a,f as s,o as f,a as l,c as w,p as B,t as x,u as E,s as N,e as q,i as v,j as D}from"./index.b81ed5cb.js";import{s as T}from"./index.9a85c2d6.js";const U=v("\u751F\u6210\u4E3B\u9898"),F={key:0,class:"exp-customTheme-code"},j=v("\u590D\u5236\u4EE3\u7801 "),z=C({setup(S){function d(e,t,n=!0){const o=D(t),u=n?"":" !default";return`
$${e}-color-1: ${o[0]}${u};
$${e}-color-2: ${o[1]}${u};
$${e}-color-3: ${o[2]}${u};
$${e}-color-4: ${o[3]}${u};
