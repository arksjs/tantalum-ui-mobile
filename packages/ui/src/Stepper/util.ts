import { formatInputNumber, getNumber, rangeInteger, rangeNumber } from '../helpers'

export const getClasses = (disabled?: boolean) => {
  return ['ta-stepper', { disabled: !!disabled }]
}

export function formatNumber(value: string | number, decimalLength?: number | string): string {
